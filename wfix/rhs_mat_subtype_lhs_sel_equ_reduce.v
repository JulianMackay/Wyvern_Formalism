...
Lemma subtype_sel_equ_sel_upp_reduce : 
...
Lemma subtype_sel_equ_sel_low_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_sel_equ_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_sel_nom_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_upp_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_low_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_equ_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_nom_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_rfn_top_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_rfn_sel_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_sha_top_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_sha_sel_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
                  forall T2 x2 L2 T' ss2, T2 = (t_sha_sel x2 L2 ss2 T') ->
                                     subtype T1 T2 = subtype T1' T2.
Proof.
  intros.
...
Lemma subtype_sel_equ_all_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_bot_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
...
Lemma subtype_sel_equ_con_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_equ x1 L1 T1') ->
