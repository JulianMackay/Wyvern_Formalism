...
Lemma subtype_equ_equ_reduce : 
  forall T1 L1 T1', T1 = (t_equ L1 T1') ->
               forall T2 L2 T2', T2 = (t_equ L2 T2') ->
                            subtype T1 T2 = andb (eq_label L1 L2)
                                                 (andb (subtype T1' T2')
                                                       (subtype T2' T1')).
Proof.
  intros.
...
Lemma subtype_equ_upp_reduce : 
  forall T1 L1 T1', T1 = (t_equ L1 T1') ->
               forall T2 L2 T2', T2 = (t_upp L2 T2') ->
                            subtype T1 T2 = (eq_label L1 L2) && subtype T1' T2'.
Proof.
  intros.
...
Lemma subtype_equ_other_reduce : 
  forall T1 L T1', T1 = (t_equ L T1') ->
              forall T2, (forall T2', T2 <> (t_upp L T2')) ->
                    (forall T2', T2 <> (t_low L T2')) ->
                    (forall T2', T2 <> (t_equ L T2')) ->
                    subtype T1 T2 = false.
Proof.
  intros.
