...
Lemma subtype_sel_nom_sel_upp_reduce : 
...
Lemma subtype_sel_nom_sel_low_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_sel_equ_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_sel_nom_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_upp_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_low_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_equ_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_rfn_top_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_sha_top_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_sha_sel_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_all_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_bot_reduce : 
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_nil_reduce :
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Lemma subtype_sel_nom_con_reduce :
  forall T1 x1 L1 T1', T1 = (t_sel_nom x1 L1 T1') ->
...
Proof.
  ...
  subst;
    eapply subtype_sel_nom_nom_reduce
      with (x1:=x1)(L1:=L1)(T1':=T1')(L2:=l)(T2':=T2);
    eauto.
