...
Require Export common.lhs_sel_low_reduce.rhs_nil_reduce.
Require Export common.lhs_sel_low_reduce.rhs_con_reduce.

Require Export common.lhs_sel_low_reduce.rhs_sel_equ_reduce.
Require Export common.lhs_sel_low_reduce.rhs_sel_upp_reduce.
Require Export common.lhs_sel_low_reduce.rhs_sel_low_reduce.
Require Export common.lhs_sel_low_reduce.rhs_sel_nom_reduce.
Require Export common.lhs_sel_low_reduce.rhs_sel_bnd_reduce.

Require Export common.lhs_sel_low_reduce.rhs_bot_reduce.

Require Export common.lhs_sel_low_reduce.rhs_all_reduce.

Require Export common.lhs_sel_low_reduce.rhs_rfn_sel_reduce.
Require Export common.lhs_sel_low_reduce.rhs_rfn_top_reduce.
Require Export common.lhs_sel_low_reduce.rhs_sha_sel_reduce.
Require Export common.lhs_sel_low_reduce.rhs_sha_top_reduce.

Require Export common.lhs_sel_low_reduce.rhs_upp_reduce.
Require Export common.lhs_sel_low_reduce.rhs_nom_reduce.
Require Export common.lhs_sel_low_reduce.rhs_equ_reduce.
Require Export common.lhs_sel_low_reduce.rhs_low_reduce.
...
Proof.
  ...
  subst;
    apply subtype_sel_low_sel_bnd_reduce
      with (x1:=x1)(L1:=L1)(T1':=T1');
    auto.
