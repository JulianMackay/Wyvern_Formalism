...
Require Export rhs_sel_equ_reduce.
Require Export rhs_sel_upp_reduce.
Require Export rhs_sel_low_reduce.
Require Export rhs_sel_nom_reduce.
Require Export rhs_sel_bnd_reduce.

Require Export rhs_bot_reduce.

Require Export rhs_all_reduce.

Require Export rhs_sha_sel_reduce.
Require Export rhs_sha_top_reduce.
Require Export rhs_rfn_sel_reduce.
Require Export rhs_rfn_top_reduce.

Require Export rhs_upp_reduce.
Require Export rhs_nom_reduce.
Require Export rhs_equ_reduce.
Require Export rhs_low_reduce.
...
Lemma subtype_sel_upp_reduce :
  forall T1 x1 L1 T1',
    ...
    forall T2, subtype T1 T2 = match T2 with
                          ...
                          | t_sel_bnd x2 L2 _ => orb (andb (eq_var x1 x2) (eq_label L1 L2)) (subtype T1' T2)
                          | t_upp L2 T2' => false
                          | t_low L2 T2' => false
                          | t_equ L2 T2' => false
                          | t_nom L2 T2' => false
