...
Lemma subtype_rhs_sel_low_reduce :
  forall T2 x L T2', T2 = t_sel_low x L T2' ->
...
Proof.
  ...
  erewrite subtype_sel_upp_sel_low_reduce; eauto;
    rewrite H0;
    repeat rewrite orb_true_r;
    auto.

  erewrite subtype_sel_low_sel_low_reduce; eauto;
    rewrite H0;
    repeat rewrite orb_true_r;
    auto.

  erewrite subtype_sel_equ_sel_low_reduce; eauto;
    rewrite H0;
    repeat rewrite orb_true_r;
    auto.

  erewrite subtype_sel_nom_sel_low_reduce; eauto;
    rewrite H0;
    repeat rewrite orb_true_r;
    auto.

  erewrite subtype_sel_bnd_sel_low_reduce; eauto;
    rewrite H0;
    repeat rewrite orb_true_r;
    auto.

  erewrite subtype_rfn_top_sel_low_reduce; eauto.

  erewrite subtype_rfn_sel_sel_low_reduce; eauto;
    rewrite H0;
    repeat rewrite orb_true_r;
    auto.

  erewrite subtype_sha_top_sel_low_reduce; eauto.

  erewrite subtype_sha_sel_sel_low_reduce; eauto;
    rewrite H0;
    repeat rewrite orb_true_r;
    auto.

  erewrite subtype_all_sel_low_reduce; eauto.
